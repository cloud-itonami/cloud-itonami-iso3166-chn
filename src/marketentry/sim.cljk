...
(defn -main [& _]
  (let [db (store/seed-db)
    ...
    (println "== jurisdiction/assess eng-4 (sets up domestic-entity-missing) ==")
    ...
    (println "== filing/submit eng-4 (domestic-entity-missing -> HARD hold) ==")
    (println (exec-op actor "t9" {:op :filing/submit :subject "eng-4"} operator))

    (println "== jurisdiction/assess eng-5 (sets up uscc-unverified) ==")
    ...
    (println "== filing/submit eng-5 (uscc-unverified -> HARD hold) ==")
