...
Open ISO 3166 Blueprint for **CHN**: People's Republic of China.
...
tax registration, and local-content rules in China, so the operator
...
- **Not the government of China.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Chinese-licensed counsel
...
(ISO 3166 `CHN`). Required capabilities:
